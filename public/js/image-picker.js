...
(function() {
  ...
  ImagePicker = (function() {
    ...
    ImagePicker.prototype.create_picker = function() {
      this.picker = jQuery("<ul id=\"ulSel\" class='thumbnails image_picker_selector'></ul>");
      this.picker_options = [];
    ...
    ImagePicker.prototype.recursively_parse_option_groups = function(scoped_dom, target_container) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        target_container.append(jQuery("<li style=\"list-style-type: none;\">").append(container));
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, thumbnail;
      this.node = jQuery("<li/>");
      image = jQuery("<img class='image_picker_image' height=\"122\", width=\"215\"/>");
